package exercises;
	...
	public class Donor2
	{
	  ...
	  public void updateRating(int amount)
	  {
	    ...
	    public Donor2(String str, String str2,int amount)
	    {
	        name = str;
	        rating = str2;
	        amount=amt;

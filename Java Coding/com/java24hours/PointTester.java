...
class PointTester
{
	public static void main(String[] arguments)
	{
		...
		location1.move(4,13);
		System.out.println("The 2D pont is now at("+location1.x+" "+location1.y+")");
		System.out.println("It's being moved negative 10 on both axis");
		...
		+", "+location2.y+ ", " + location2.z + ")");
		System.out.println("Its being move -20 on the x"
				+ "y and z axes");

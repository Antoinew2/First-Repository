...
public class Calculator {
    ...
    public int Mem=0;//to fix the problem i was havign i declared Mem here instead of in handle key press
    public final static int APPEND = 0; // Display states
    public final static int REPLACE = 1;
    public final static int STOREMEMORY = 6;
    public final static int RECALLMEMORY = 7;
    public final static int CLEARMEMORY = 8;
    public final static int  SQUARE = 9;
...
if (keyStr.equals("SM")) {
      ...
      {
    	  int result =Integer.parseInt(external_display);

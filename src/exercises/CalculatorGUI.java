...
public class CalculatorGUI extends JFrame
    ...
    private String label[] =  // 20 keyPad Button Labels
                              {  "1","2","3","+",
                                 "4","5","6","-",
                                 "7","8","9","*",
                                 "C","0","=","/",
                                 "SM","RM","CM","X^2"}; // HINT add the label to the new buttons
    ...
    public CalculatorGUI(String title) {
        ...
        keyPadPanel.setLayout(new GridLayout (5,5,1,1)); // HINT - bigger grid for the new buttons
